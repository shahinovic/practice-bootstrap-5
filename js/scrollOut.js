        ...
        ? ((i = L.cssProps),
          function (e, t) {
            for (var n in t)
              n.indexOf('_') &&
                (!0 === i || i[n]) &&
                e.style.setProperty('--' + d(n), ((r = t[n]), Math.round(1e4 * r) / 1e4));
            var r;
          })
        : m,
    ...
    function n() {
      ...
      for (var l, c = !1, s = 0; s < y.length; s++) {
        for (
          ...
          (d += a.offsetLeft), (v += a.offsetTop), (a = a.offsetParent) && a !== A;
    ...
    function C() {
      ...
      for (var e = y.length - 1; -1 < e; e--) {
        ...
        t._changed && ((t._changed = !1), f(n, t)),
          t._visibleChanged && (h(n, { scroll: r ? 'in' : 'out' }), o(n, t, W), (r ? c : l)(n, t, W)),
